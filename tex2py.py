...
def convert_str(tex_str):
    ...
    tex_str = tex_str.replace(r'\matder', ' ')
    tex_str = tex_str.replace(r'\cdot', '*')
    tex_str = tex_str.replace(r'\exp', ' ')
    tex_str = tex_str.replace(r'\mathcal', ' ')
    tex_str = tex_str.replace(r'\mathrm', ' ')
    tex_str = tex_str.replace(r'\mathbf', ' ')
    tex_str = tex_str.replace(r'\int_S', ' ')
    tex_str = tex_str.replace(r'\int', ' ')
    ...
    tex_str = tex_str.replace(r'\tau(u_i,u_j)', 'tauuu')
    tex_str = tex_str.replace(r'_\omega', 'omega')
    tex_str = tex_str.replace(r'_{\omega}', 'omega')
    tex_str = tex_str.replace(r'\Pi_{ij}', 'Piij')
    tex_str = tex_str.replace(r'\beta^*', 'betastar')
    ...
    tex_str = tex_str.replace(r'\Psi', 'Psi')
    tex_str = tex_str.replace(r'\psi', 'psi')
    ...
    tex_str = tex_str.replace(r'\pi', 'pi')
