...
def convert_str(tex_str):
    ...
    tex_str = tex_str.replace(r'\upsilon', 'upsilon')
    tex_str = tex_str.replace(r'\Upsilon', 'Upsilon')
    tex_str = tex_str.replace(r'\phi', 'phi')
    tex_str = tex_str.replace(r'\Phi', 'Phi')
    tex_str = tex_str.replace(r'\chi', 'chi')
